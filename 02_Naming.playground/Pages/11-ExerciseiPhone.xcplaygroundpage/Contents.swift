...
*/
let maxPhoneStorageMB = 8000
let phoneStorageInUseMB = 3000
let phoneRemainingStorageMB = maxPhoneStorageMB - phoneStorageInUseMB

let oneMinuteOfVideoMB = 150

let videoMinutesItWillTakeToFillPhoneStorage = phoneRemainingStorageMB / oneMinuteOfVideoMB
