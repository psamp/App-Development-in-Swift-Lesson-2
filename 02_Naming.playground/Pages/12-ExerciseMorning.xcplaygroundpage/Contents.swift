 ...
 */
let showerAndBrushTeeth = 8
let getDressed = 15
let chooseClothesIfNotAlreadyLaidOut = 3
let doAndSetHair = 5
let cookLunchIfNotAlreadyPackedOrLeftover = 15
let feedBirds = 3
...
let morningRoutine = showerAndBrushTeeth + getDressed + chooseClothesIfNotAlreadyLaidOut + doAndSetHair + cookLunchIfNotAlreadyPackedOrLeftover + feedBirds
...
let likeTo = doAndSetHair + cookLunchIfNotAlreadyPackedOrLeftover + feedBirds
let haveTo = showerAndBrushTeeth + getDressed + chooseClothesIfNotAlreadyLaidOut
...
*/
let idealMorning = likeTo + haveTo
